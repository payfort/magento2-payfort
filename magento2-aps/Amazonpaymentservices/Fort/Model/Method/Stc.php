<?php
/**
 * Amazonpaymentservices Payment STC Model
 * php version 7.3.*
 *
 ...
 * @link     Amazonpaymentservices
 **/
class Stc extends \Amazonpaymentservices\Fort\Model\Payment
{
    const CODE = 'aps_fort_stc';
    ...
    public function isAvailable(\Magento\Quote\Api\Data\CartInterface $quote = null)
    {
        ...
        if (!$this->_helper->checkSubscriptionItemInCart()) {
            $token  = $this->_helper->getConfig('payment/aps_fort_stc/token');
            if ($token == 0) {
                return false;
            }
        }
