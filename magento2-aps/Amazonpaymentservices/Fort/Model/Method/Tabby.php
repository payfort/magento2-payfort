<?php
/**
 * Amazonpaymentservices Payment TABBY Model
 * php version 8.2.*
 *
 ...
 * @link     Amazonpaymentservices
 **/
class Tabby extends \Amazonpaymentservices\Fort\Model\Payment
{
    const CODE = 'aps_fort_tabby';
    ...
    public function isAvailable(\Magento\Quote\Api\Data\CartInterface $quote = null)
    {
        ...
        if (! in_array($this->_helper->getFortCurrency($baseCurrency, $frontCurrency), $supported_currencies)) {
            return false;
        }
